...
export function POS() {
  ...
  return (
    <div className="flex-1 flex flex-col lg:flex-row gap-4 md:gap-8 animate-in slide-in-from-right duration-500 lg:overflow-hidden overflow-y-visible pb-4 md:pb-0">
      {/* Product Selection */}
      <div className="flex-1 flex flex-col gap-4 md:gap-6 lg:min-h-0 min-h-fit lg:overflow-hidden overflow-visible">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 gap-4 lg:overflow-y-auto overflow-y-visible pb-8 flex-1 content-start pr-1 custom-scrollbar">
      ...
      {/* Cart / Checkout */}
      <div className="w-full lg:w-[400px] flex flex-col gap-6 flex-shrink-0 lg:min-h-0 min-h-fit">
        <div className="glass-card flex-1 flex flex-col overflow-hidden min-h-[400px] lg:min-h-0">
          ...
          <div className="flex-1 lg:overflow-y-auto overflow-y-visible p-6 space-y-4">
            {cart.map(item => (
            ...
            {cart.length === 0 && (
              <div className="h-full min-h-[150px] flex flex-col items-center justify-center text-center py-12 opacity-40">
